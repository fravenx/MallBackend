...
public interface CartMapper {
    // 获取某个用户的所有购物车信息
    @Select("SELECT cart_id, cart.product_id, img_src, product_name, product_price,discount,weight, count FROM cart, product WHERE user_id=#{userId} AND cart.product_id=product.product_id")
